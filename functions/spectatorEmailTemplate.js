...
export const generateSpectatorEmail = async (paymentDetails) => {
  ...
  if (qrCodeDataUrl) {
    ...
    attachments.push({
      filename: `IWKA-cup-ticket-${razorpay_payment_id}.png`,
      content: base64Data,
      encoding: 'base64',
  ...
  return {
    subject: "🎟️ Spectator Tickets Confirmed - IWKA Cup 2026",
    html: `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
        <div class="email-wrapper">
          <div class="header">
            ...
            <p>Welcome to IWKA Cup 2026</p>
          </div>

          <div class="content">
            <p class="greeting">Dear ${name || 'Spectator'},</p>
            <p class="intro-text">
              Thank you for your purchase! Your spectator ${parseInt(ticketQuantity) > 1 ? 'tickets are' : 'ticket is'} confirmed for <strong>IWKA Cup 2026</strong>. Get ready to witness incredible martial arts action! 🥋
            </p>
            ...
            <div class="contact-section">
              ...
              <p>Email: <a href="mailto:iwkatournament2026@gmail.com">iwkatournament2026@gmail.com</a></p>
            </div>
          </div>

          <div class="footer">
            <div class="footer-logo">🥋</div>
            <p><strong>IWKA Cup 2026</strong></p>
            ...
            <p style="font-size: 12px; opacity: 0.8;">
              ...
              For support, contact us at iwkatournament2026@gmail.com
            </p>
            <p style="margin-top: 15px; font-size: 11px; opacity: 0.7;">
              © 2026 IWKA Cup. All rights reserved.
            </p>
          </div>
        </div>
      </body>
    ...
    `,
    text: `
🎟️ SPECTATOR TICKETS CONFIRMED - IWKA CUP 2025

Dear ${name || 'Spectator'},

Thank you for your purchase! Your spectator ${parseInt(ticketQuantity) > 1 ? 'tickets are' : 'ticket is'} confirmed for IWKA CUP 2025.
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
Need help? Contact us at: iwkatournament2026@gmail.com
