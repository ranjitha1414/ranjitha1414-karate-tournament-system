...
export const generateParticipantEmail = async (paymentDetails) => {
  ...
  if (qrCodeDataUrl) {
    ...
    attachments.push({
      filename: `IWKA-cup-registration-${paymentId}.png`,
      content: base64Data,
      encoding: 'base64',
  ...
  return {
    subject: "🥋 Registration Confirmed - IWKA Cup 2026",
    html: `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
        <div class="email-wrapper">
          ...
          <div class="content">
            ...
            <p class="intro-text">
              Congratulations! Your registration for <strong>IWKA Cup 2026</strong> has been successfully confirmed. Get ready to showcase your skills and compete with the best martial artists! 🥋
            </p>
    ...
    `,
    text: `
🥋 REGISTRATION CONFIRMED - IWKA CUP 2026

Dear ${customerName || 'Participant'},

Congratulations! Your registration for IWKA Cup 2026 has been successfully confirmed.
